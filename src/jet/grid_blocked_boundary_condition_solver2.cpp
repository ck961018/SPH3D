...
void GridBlockedBoundaryConditionSolver2::constrainVelocity(FaceCenteredGrid2* velocity,
...
void GridBlockedBoundaryConditionSolver2::onColliderUpdated(const Size2& gridSize,
