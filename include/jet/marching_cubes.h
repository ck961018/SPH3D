...
void marchingCubes(const ConstArrayAccessor3<double>& grid, const Vector3D& gridSize,
                   const Vector3D& origin, TriangleMesh3* mesh, double isoValue = 0,
                   int bndClose = kDirectionAll, int bndConnectivity = kDirectionNone);

void marchingSquares(const ConstArrayAccessor2<double>& grid, const Vector2D& gridSize,
                     const Vector2D& origin, TriangleMesh3* mesh, double isoValue = 0);
